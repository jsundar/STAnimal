...
public class TokenGenerator {
	...
	public String generateToken(String username) {
		...
		claims.put("ïd", UUID.randomUUID().toString());
	...
	public void validateToken(String token, String username) {
		if (!username.equals(getUsernameFromToken(token)) && !isTokenExpired(token)) {
			throw new ApplicationException(ApplicationError.UN_AUTHORIZED);
		}
	}
